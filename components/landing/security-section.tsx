...
const securityFeatures = [
  {
    icon: Shield,
    title: "24/7 Security",
    description: "Professional security team monitoring all areas around the clock.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Private Access",
    description: "Secure key card access to rooms and exclusive areas.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Guest Privacy",
    description: "Strict confidentiality and discretion for all guest information.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Safety Standards",
    description: "Exceeds all international hospitality and safety regulations.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["ISO 9001", "LEED Certified", "TripAdvisor Certified", "AAA 5-Star"];
        ...
        <div className="mb-20">
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Your safety and privacy are paramount. State-of-the-art security systems and protocols protect you 24/7.
            </p>
          </div>
        </div>
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8">
                ...
                <span className="block text-muted-foreground mt-2">Guest safety compliance record</span>
              </div>
            </div>
