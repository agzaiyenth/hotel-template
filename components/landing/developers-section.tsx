...
const features = [
  ...
  { 
    ...
    description: "Quick service fulfillment for all guest requests."
  },
  { 
    title: "Multilingual team", 
    description: "Fluent service in 12+ languages worldwide."
  },
  { 
    title: "Personalized service", 
    description: "Customized experiences tailored to guest preferences."
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          <p className="text-xl text-muted-foreground mb-12 leading-relaxed max-w-md">
            Our world-class concierge team is dedicated to fulfilling your every request. 
            From reservations to unforgettable experiences, we deliver excellence.
          </p>
