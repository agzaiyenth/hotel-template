...
const steps = [
  {
    ...
    title: "Browse",
    subtitle: "& discover",
    description: "Explore our curated collection of luxury suites. View detailed photos, amenities, and real guest reviews to find your perfect room.",
  },
  {
    number: "02",
    title: "Customize",
    subtitle: "your stay",
    description: "Request special arrangements. From spa treatments to dining reservations, our concierge handles every detail of your experience.",
  },
  {
    number: "03",
    title: "Experience",
    subtitle: "perfection",
    description: "Arrive to personalized touches, seamless service, and unforgettable moments. Our team ensures every detail exceeds expectations.",
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className={`relative h-[320px] lg:h-[640px] overflow-hidden transition-all duration-1000 delay-200 ${
            ...
            <img
              src="/booking-process.png"
              alt="Hotel booking process"
              aria-hidden="true"
