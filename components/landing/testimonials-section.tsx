...
const testimonials = [
  {
    quote: "An absolutely extraordinary experience. The attention to detail and personalized service made our anniversary unforgettable. We'll be back!",
    author: "Margaret Thompson",
    role: "Guest",
    company: "New York",
    metric: { value: "5★", label: "Experience rating" },
  },
  {
    quote: "The spa treatment was transformative. The therapists truly understood wellness and holistic healing. Absolutely phenomenal.",
    author: "David Kumar",
    role: "Guest",
    company: "London",
    metric: { value: "5★", label: "Spa rating" },
  },
  {
    quote: "Fine dining at its finest. The chef's tasting menu was a culinary masterpiece. Every course was perfection.",
    author: "Isabella Rossi",
    role: "Guest",
    company: "Milan",
    metric: { value: "5★", label: "Dining rating" },
  },
  {
    quote: "The concierge arranged the most perfect yacht excursion. Every detail was impeccable. Luxury redefined.",
    author: "James Patterson",
    role: "Guest",
    company: "Sydney",
    metric: { value: "5★", label: "Service rating" },
  },
];

function createAsciiPattern(rows: number, columns: number) {
  return Array.from({ length: rows }, (_, rowIndex) =>
    Array.from({ length: columns }, (_, columnIndex) =>
      ((rowIndex * 17 + columnIndex * 31) % 10) > 6 ? '"' : ' '
    ).join("")
  ).join("\n");
}
