...
const regions = [
  { name: "Caribbean Paradise", nodes: 250, status: "operational" },
  { name: "European Coast", nodes: 180, status: "operational" },
  { name: "Asian Riviera", nodes: 320, status: "operational" },
  { name: "Mediterranean Gems", nodes: 200, status: "operational" },
];
        ...
        <div className="mb-20">
          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 items-stretch">
            ...
            <div className={`w-48 lg:w-72 xl:w-80 shrink-0 transition-all duration-1000 ${
              ...
              <img
                src="/amenities-bg.png"
                alt="Marina luxury properties worldwide"
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg transition-all duration-1000 delay-100 ${
                ...
                Marina properties span across the world's most prestigious destinations.
                Consistent luxury and service across all locations.
              </p>
            </div>
          </div>
        </div>
